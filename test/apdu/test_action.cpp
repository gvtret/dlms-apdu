...
constexpr std::array<std::uint8_t, 7> kActionResponseNormal = {
  0xC7, 0x01, 0x81, 0x00, 0x01, 0x11, 0x2A};
...
TEST(ActionCodecTest, RoundTripsActionResponseVariants)
{
  ...
  constexpr std::array<std::uint8_t, 10> withList = {
    0xC7, 0x03, 0x81, 0x02, 0x00, 0x00, 0x00, 0x01, 0x11, 0x2A};
